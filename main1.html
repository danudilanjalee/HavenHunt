...
<section id="listings" class="container py-5">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="Coral Homes.jpg" class="card-img-top" alt="Modern Family Home">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="Fortune.JFIF" class="card-img-top" alt="City Apartment">
                <div class="card-body">
                    ...
                    <p class="card-text"><strong>$600,000</strong></p>
                    <a href="#" class="btn btn-primary">View Details</a>
                </div>
            </div>
        </div>
