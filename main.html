...
<head>
    ...
    <style>
        ...
        header {
            background-image: url('unnamed.jpg'); /* Replace 'unnamed.jpg' with your image file */
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        ...
        <img src="Havent Hunt.jpg" height="150">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link btn btn-primary text-Blue" href="login.html">Login/Register</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<section id="listings" class="container py-5">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="Coral Homes.jpg" class="card-img-top">
                <div class="card-body">
